# AngularSeedApp
Angular skeleton application designed to quick start your webapp. Developers can concentrate on building business specific requirements and forget the overheads, thus considerably reducing efforts. It comes fully integrated with Angular, Express, Concurrently, Bootstrap, Font Awesome and some animations.
